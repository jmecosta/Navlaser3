...
mainwnd *mainwnd::mainwnd_create(rtk_app_t *app, const char *host, int port) {
	char title[128];
	mainwnd *wnd;
...
void mainwnd::mainwnd_destroy(mainwnd *wnd)
{
...
int mainwnd::mainwnd_update(mainwnd *wnd)
{
	//char filename[256];
...
void mainwnd::mainwnd_update_export(mainwnd *wnd)
{
	char filename[1024];
