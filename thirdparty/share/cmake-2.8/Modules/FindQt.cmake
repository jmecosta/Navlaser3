...
# now find qmake
MESSAGE (STATUS "\n\n====== FIND QT ====== " QT_QMAKE_EXECUTABLE_FINDQT)
MESSAGE (STATUS "\n\n====== FIND QT ====== " )
MESSAGE (STATUS "\n\n====== FIND QT ====== " )
MESSAGE (STATUS "\n\n====== FIND QT ====== " )

FIND_PROGRAM(QT_QMAKE_EXECUTABLE_FINDQT NAMES qmake PATHS "${QT_SEARCH_PATH}/bin" "$ENV{QTDIR}/bin" ${PROJECT_ROOT_DIR}/thirdparty/bin)
