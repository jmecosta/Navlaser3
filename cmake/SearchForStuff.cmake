...
if (PKG_CONFIG_FOUND)
  ...
  ## Cppunit needed for unit testing
  pkg_check_modules(CPPUNIT REQUIRED cppunit>=1.12.1)
  if (NOT CPPUNIT_FOUND)
    set (INCLUDE_CPPUNIT OFF CACHE BOOL "SET CPPUNIT FORCE" FORCE)
    message (STATUS "Warning: CPPUNIT not found. ${navlaserplayer} will not be built. See the following website: TBC")
  else (NOT CPPUNIT_FOUND)
    set (INCLUDE_CPPUNIT ON CACHE BOOL "Set gtk Libs" FORCE)
    set (CPPUNIT_INCLUDE_DIRS ${CPPUNIT_INCLUDE_DIRS} CACHE INTERNAL "CPPUNIT include directory")
    set (CPPUNIT_LINK_DIRS ${CPPUNIT_LIBRARY_DIRS} CACHE INTERNAL "CPPUNIT link directory")
    set (CPPUNIT_LINK_LIBS ${CPPUNIT_LIBRARIES} CACHE INTERNAL "CPPUNIT libraries")
